...
## Purpose
Defines the backend auction engine MVP for the live auction system: bid acceptance, wallet freeze/unfreeze, rankings, state transitions, settlement, cancellation, and audit logging. Realtime WebSocket delivery, H5 room UI, and order/payment workflows are separate capabilities.
