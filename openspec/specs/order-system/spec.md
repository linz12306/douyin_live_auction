...
## Purpose
Defines the post-win order workflow for the live auction system: using auction-engine generated `pending_confirm` orders, buyer confirmation, simulated payment, pre-confirm cancellation and timeout refund, buyer order views, merchant order inspection, and frontend order entry points.
## Requirements
