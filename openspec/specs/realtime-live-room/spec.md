# realtime-live-room Specification

## Purpose
Defines the user-facing realtime auction room experience, including auction lobby entry, WebSocket room snapshots, realtime bid/ranking/countdown updates, private outbid notifications, terminal state updates, and frontend rules that keep WebSocket messages as the realtime source of truth.
## Requirements
